...
Đây là bản tóm tắt để nhận biết phạm vi áp dụng; legal code chính thức tại liên kết trên là điều khoản có hiệu lực.

## Ranh giới phạm vi

- Mã nguồn, script, schema và các thành phần phần mềm được cấp phép riêng theo **GNU AGPL-3.0** trong `LICENSE`.
- Tên bên thứ ba, văn bản chính thức, tên SGK và tài liệu có bản quyền của bên thứ ba vẫn thuộc chủ sở hữu tương ứng.
- Repository không cấp quyền sao chép nguyên văn bài tập SGK hoặc nội dung bên thứ ba ngoài phạm vi mà pháp luật cho phép.
- Học liệu sinh bởi mô hình không phải tài liệu hoặc đề chính thức của Bộ Giáo dục và Đào tạo.

Việc đổi giấy phép không thu hồi các quyền đã được cấp hợp lệ đối với bản nội dung mà người nhận đã nhận trước đó theo CC BY 4.0.
